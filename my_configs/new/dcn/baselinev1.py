...
model = dict(
    ...
    rpn_head=dict(
        ...
        feat_channels=256,
        anchor_scales=[8],
        anchor_ratios=[0.2,0.25,0.5,0.7, 1.0,1.33, 2.0,4.0,5.0],
...
test_cfg = dict(
    ...
    rcnn=dict(
        score_thr=0.0, nms=dict(type='soft_nms', iou_thr=0.5), max_per_img=50))
# dataset settings
...
load_from = "/datassd/yuejian/mmdetection/model/7cascade_rcnn_dconv_c3-c5_r50_fpn_1x_coco_pretrained_weights_classes_8.pth"
